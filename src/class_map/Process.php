...
class Process
{
    ...
    protected function putCache(mixed $path, mixed $data)
    {
    ...
    protected function deleteAspectClasses(mixed $aspectClasses, mixed $proxies, mixed $class): void
    {
